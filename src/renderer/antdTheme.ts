...
export const antdTheme: ThemeConfig = {
  ...
  components: {
    ...
    Select: {
      ...
      colorBorder: themedark.color.border,
      colorBgElevated: themedark.color.surface,
      colorPrimaryHover: themedark.color.accentHover,
      controlOutline: 'transparent',
      optionSelectedBg: themedark.color.fillStrong,
      optionActiveBg: themedark.color.fill,
      controlItemBgActiveHover: themedark.color.fillStrong,
      optionSelectedColor: themedark.color.text,
      colorText: themedark.color.textBody,
      controlItemBgHover: themedark.color.fill,
      colorTextQuaternary: themedark.color.textMuted,
      colorTextPlaceholder: themedark.color.textMuted,
    },
    Slider: {
