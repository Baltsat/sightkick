...
const publicReleaseHref =
  'https://github.com/Baltsat/sightkick/releases/download/v1.2.0-kb.17/Drumroll-1.2.0-kb.17-arm64.dmg';
const publicChecksumHref =
  'https://github.com/Baltsat/sightkick/releases/download/v1.2.0-kb.17/SHA256SUMS.txt';
    ...
    <main class="web-landing">
      ...
      <section class="web-download-section" aria-labelledby="web-download-title">
        <div class="web-download-copy">
          ...
          <p>Drumroll 1.2.0-kb.17 is the Apple Silicon macOS release. The public artifact is Developer ID signed, Apple notarized, and published with a reproducible SHA-256 checksum.</p>
        </div>
      ...
      <section class="web-faq-section" aria-labelledby="web-faq-title">
        ...
        <div class="web-faq-list">
          ...
          <details><summary>Is this download link public?</summary><p>Yes. It points to the exact v1.2.0-kb.17 GitHub release asset; SHA256SUMS.txt is published beside it.</p></details>
        </div>
      </section>
