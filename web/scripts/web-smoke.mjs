...
const shotDir = path.join(repoRoot, 'scratchpad/web-shots');
...
try {
  ...
  await page
    .getByRole('heading', { name: /play the kit/i })
    .waitFor({ timeout: 120_000 });
  await page.screenshot({
    path: path.join(shotDir, '01-landing.png'),
    animations: 'disabled',
    timeout: 120_000,
  });
  ...
  await page.getByTestId('start-drumroll').click();
